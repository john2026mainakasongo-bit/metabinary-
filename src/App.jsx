  ...
  return (
    <>
      ...
      <div className="app">
        ...
        <div className="nav">
          <button className="menuBtn" type="button" onClick={() => setMenuOpen(true)}>☰</button>
          ...
          <>
            ...
            <div className="panel">
              ...
              <div className="contractGrid">
                <button className={mode === "risefall" ? "active" : ""} onClick={() => setMode("risefall")}>Rise/Fall</button>
                <button className={mode === "evenodd" ? "active" : ""} onClick={() => setMode("evenodd")}>Even/Odd</button>
                <button className={mode === "matchesdiffers" ? "active" : ""} onClick={() => setMode("matchesdiffers")}>Matches/Differs</button>
                <button className={mode === "overunder" ? "active" : ""} onClick={() => setMode("overunder")}>Over/Under</button>
              </div>
            </div>
